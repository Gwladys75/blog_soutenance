...
?>
  ...
  <!-- SECTION POLAROID 3 -->
  <!-- Section contenant 3 images avec effet polaroid -->
  <section class="container m-5 p-5 ms-auto d-flex flex-wrap">
    <div class="row">   
      <!-- Première image avec effet polaroid, avec une classe "rotate1" pour l'effet de rotation -->
      <div class="col-12 col-sm-6 col-md-4">
        <div class="polaroid rotate1">
          <img src="assets/img/tambouyes.jpg" alt="joueurs de tambours">
          <p class="text-pola">Tambouyés (joueurs de tambour) et joueur de chacha </p>
        </div>
      </div>

      <!-- Deuxième image avec effet polaroid, avec une classe "rotate2" pour l'effet de rotation -->
      <div class="col-12 col-sm-6 col-md-4">
        <div class="polaroid rotate2">
          <img src="assets/img/boula-et-make.jpg" alt="deux tambours">
          <p class="text-pola"> 2 tambours boula(tabours des accompagnateurs)et makè (tambour du soliste)</p>
        </div>
      </div>

      <!-- Troisième image avec effet polaroid, avec une classe "rotate3" pour l'effet de rotation -->
      <div class="col-12 col-sm-6 col-md-4">
        <div class="polaroid rotate3">
          <img src="assets/img/soiree_esclaves_gwoka.png" alt="soirée gwoka des esclaves">
          <p class="text-pola"> Soirée des esclaves jouant et dansant du gwoka</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <!-- Section contenant un paragraphe de définition du Gwoka -->
  ...
  <!-- SECTION PHOTOS POLAROID 4 -->
  <!-- Section contenant 4 images avec effet polaroid -->
  <section class="container d-flex flex-wrap">
   
    <div class="row pb-5 pt-5 mt-5 mb-5">
      <!-- Première image avec effet polaroid, avec une classe "rotate1" pour l'effet de rotation -->
      ...
      <!-- Troisième image avec effet polaroid, avec une classe "rotate1" pour l'effet de rotation -->
      <div class="col-12 col-sm-6 col-md-3">
        <div class="polaroid rotate1">
      ...
      <!-- Quatrième image avec effet polaroid, avec une classe "rotate2" pour l'effet de rotation -->
      <div class="col-12 col-sm-6 col-md-3">
        <div class="polaroid rotate2 ">
